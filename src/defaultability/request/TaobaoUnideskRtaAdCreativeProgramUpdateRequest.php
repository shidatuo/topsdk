...
use Topsdk\Topapi\Defaultability\Domain\TaobaoUnideskRtaAdCreativeProgramUpdateCreativeGroupTopDTO;

class TaobaoUnideskRtaAdCreativeProgramUpdateRequest {
    ...
    public function getCreativeGroupTopDto() : TaobaoUnideskRtaAdCreativeProgramUpdateCreativeGroupTopDTO{
        return $this->creativeGroupTopDto;
    }

    public function setCreativeGroupTopDto(TaobaoUnideskRtaAdCreativeProgramUpdateCreativeGroupTopDTO $creativeGroupTopDto){
