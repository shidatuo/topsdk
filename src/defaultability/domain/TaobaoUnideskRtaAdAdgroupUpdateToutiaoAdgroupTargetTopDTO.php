...
class TaobaoUnideskRtaAdAdgroupUpdateToutiaoAdgroupTargetTopDTO {
    ...
    public function getAwemeFanBehavior() : TaobaoUnideskRtaAdAdgroupUpdateAwemeFanBehaviorDTO{
        return $this->aweme_fan_behavior;
    }

    public function setAwemeFanBehavior(TaobaoUnideskRtaAdAdgroupUpdateAwemeFanBehaviorDTO $awemeFanBehavior){
