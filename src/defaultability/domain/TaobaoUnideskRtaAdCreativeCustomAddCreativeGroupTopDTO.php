...
class TaobaoUnideskRtaAdCreativeCustomAddCreativeGroupTopDTO {
    ...
    public function getToutiao() : TaobaoUnideskRtaAdCreativeCustomAddToutiaoCreativeGroupTopDTO{
        return $this->toutiao;
    }

    public function setToutiao(TaobaoUnideskRtaAdCreativeCustomAddToutiaoCreativeGroupTopDTO $toutiao){
