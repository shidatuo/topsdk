...
class TaobaoUnideskRtaAdCreativeCustomAddCreativeTopDTO {
    ...
    public function getToutiao() : TaobaoUnideskRtaAdCreativeCustomAddToutiaoCreativeTopDTO{
        return $this->toutiao;
    }

    public function setToutiao(TaobaoUnideskRtaAdCreativeCustomAddToutiaoCreativeTopDTO $toutiao){
