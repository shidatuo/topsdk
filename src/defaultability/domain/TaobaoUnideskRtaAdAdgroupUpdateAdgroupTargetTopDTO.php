...
class TaobaoUnideskRtaAdAdgroupUpdateAdgroupTargetTopDTO {
    ...
    public function getArea() : TaobaoUnideskRtaAdAdgroupUpdateAreaDTO{
        return $this->area;
    }

    public function setArea(TaobaoUnideskRtaAdAdgroupUpdateAreaDTO $area){
        $this->area = $area;
    }

    public function getInterestAction() : TaobaoUnideskRtaAdAdgroupUpdateInterestActionDTO{
        return $this->interest_action;
    }

    public function setInterestAction(TaobaoUnideskRtaAdAdgroupUpdateInterestActionDTO $interestAction){
    ...
    public function getDevice() : TaobaoUnideskRtaAdAdgroupUpdateDeviceDTO{
        return $this->device;
    }

    public function setDevice(TaobaoUnideskRtaAdAdgroupUpdateDeviceDTO $device){
        $this->device = $device;
    }
    ...
    public function getAge() : TaobaoUnideskRtaAdAdgroupUpdateAgeDTO{
        return $this->age;
    }

    public function setAge(TaobaoUnideskRtaAdAdgroupUpdateAgeDTO $age){
        $this->age = $age;
    }
    ...
    public function getToutiao() : TaobaoUnideskRtaAdAdgroupUpdateToutiaoAdgroupTargetTopDTO{
        return $this->toutiao;
    }

    public function setToutiao(TaobaoUnideskRtaAdAdgroupUpdateToutiaoAdgroupTargetTopDTO $toutiao){
