...
class TaobaoUnideskRtaAdAdgroupAddToutiaoAdgroupTargetTopDTO {
    ...
    public function getAwemeFanBehavior() : TaobaoUnideskRtaAdAdgroupAddAwemeFanBehaviorDTO{
        return $this->aweme_fan_behavior;
    }

    public function setAwemeFanBehavior(TaobaoUnideskRtaAdAdgroupAddAwemeFanBehaviorDTO $awemeFanBehavior){
