...
class TaobaoUnideskRtaAdCreativeCustomUpdateCreativeTopDTO {
    ...
    public function getToutiao() : TaobaoUnideskRtaAdCreativeCustomUpdateToutiaoCreativeTopDTO{
        return $this->toutiao;
    }

    public function setToutiao(TaobaoUnideskRtaAdCreativeCustomUpdateToutiaoCreativeTopDTO $toutiao){
