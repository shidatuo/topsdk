...
class TaobaoUnideskRtaAdCreativeProgramUpdateCreativeGroupTopDTO {
    ...
    public function getToutiao() : TaobaoUnideskRtaAdCreativeProgramUpdateToutiaoCreativeGroupTopDTO{
        return $this->toutiao;
    }

    public function setToutiao(TaobaoUnideskRtaAdCreativeProgramUpdateToutiaoCreativeGroupTopDTO $toutiao){
